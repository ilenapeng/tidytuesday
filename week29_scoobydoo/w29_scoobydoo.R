...
df_top5$word <- str_replace_all(df_top5$word, "Scooby Doo", "Scooby-Doo")
...
plot <- df_top5 %>%
  ...
  labs(
    title = "Catchphrases in Scooby-Doo",
    subtitle = 'Times each phrase was said in Scooby-Doo episodes and movies',
  ...
  theme(
    ...
    plot.subtitle = element_text(family = 'Helvetica', face='bold', size=15, color='#282C70'),
